...
//    public static String getHotelListString(HotelCity city) throws Exception {
//        CloseableHttpClient httpClient = HttpClients.createDefault();
//        HttpPost httpPost = new HttpPost("http://hotels.ctrip.com/Domestic/Tool/AjaxHotelList.aspx");
